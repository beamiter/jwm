...
impl<C: CompositorConnection> Compositor<C> {
    ...
    pub(super) fn run_blur_passes_from_fbo(
        ...
        unsafe {
            ...
            self.gl
                .bind_framebuffer(glow::DRAW_FRAMEBUFFER, Some(*scene_fbo));
            ...
            self.gl
                .uniform_1_i32(self.blur_down_uniforms.texture.as_ref(), 0);
            ...
            for level in &self.blur_fbos[..levels] {
                ...
                self.gl.uniform_matrix_4_f32_slice(
                    self.blur_down_uniforms.projection.as_ref(),
                    false,
                    &hp_proj,
                );
            ...
            self.gl
                .uniform_1_i32(self.blur_up_uniforms.texture.as_ref(), 0);
            ...
            for i in (0..levels - 1).rev() {
                ...
                self.gl.uniform_matrix_4_f32_slice(
                    self.blur_up_uniforms.projection.as_ref(),
                    false,
                    &hp_proj,
                );
                self.gl.uniform_4_f32(
