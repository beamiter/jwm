...
impl<C: CompositorConnection> Compositor<C> {
    pub(crate) fn new(
        ...
        Ok(Self {
            ...
            fade_exclude: behavior.fade_exclude.clone(),
            ...
            recording_cursor_program: None,
            recording_cursor_rect: None,
            recording_cursor_target: None,
            recording_cursor_sampler_loc: None,
            recording_cursor_texture: None,
            recording_cursor_texture_serial: None,
            recording_pack_program: None,
            recording_pack_source: None,
            recording_pack_video_size: None,
